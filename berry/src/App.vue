<template>
    <body class="is-preload">
        ...
        <div id="wrapper">
            ...
            <header id="header">
                <div class="logo">
                    <img src="../public/images/berry.png" alt="Berry Logo">
                </div>
                <div class="content">
                    <div class="inner">
                        <h1>Berry Produções</h1>
                ...
                <nav>
                    <ul>
                        <li><a href="#intro">A Berry</a></li>
                        <li><a href="#work">Work</a></li>
                        <li><a href="#about">Contato</a></li>
                        <li><a href="#contact">Portifólio</a></li>
            ...
            <div id="main">
                ...
                <article id="intro">
                    ...
                    <p>Aenean ornare velit lacus, ac varius enim ullamcorper eu. Proin aliquam facilisis ante interdum
                        ...
                        Ut magna finibus nisi nec lacinia. Nam maximus erat id euismod egestas. By the way, check out my
                ...
                <article id="work">
                    ...
                    <p>Adipiscing magna sed dolor elit. Praesent eleifend dignissim arcu, at eleifend sapien imperdiet
                        ac. Aliquam erat volutpat. Praesent urna nisi, fringila lorem et vehicula lacinia quam. Integer
                ...
                <article id="about">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur et adipiscing elit. Praesent eleifend dignissim arcu, at
                        ...
                        vehicula lacinia quam. Integer sollicitudin mauris nec lorem luctus ultrices. Aliquam libero et
                        malesuada fames ac ante ipsum primis in faucibus. Cras viverra ligula sit amet ex mollis mattis
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
            ...
            <!-- Footer -->
            <footer id="footer">
                <p class="copyright">&copy; Design By <a href="https://www.instagram.com/uelorapha/">U3DA</a>.</p>
            </footer>
